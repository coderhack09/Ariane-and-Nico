...
export function CoupleVideo() {
  ...
  // https://youtu.be/8mM9vIoS2zA
  // YouTube video ID
  const videoId = "8mM9vIoS2zA"
  ...
  return (
    <>
      ...
      <Section
        id="couple-video"
        className="relative bg-[#8B6F5A] py-8 sm:py-10 md:py-12 lg:py-16 overflow-hidden"
      >
      {/* Background */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#8B6F5A] to-[#8B6F5A]" />
      </div>
      ...
      <div className="relative z-10 text-center mb-4 sm:mb-6 md:mb-8 lg:mb-10 px-3 sm:px-4">
        ...
        <div className="flex items-center justify-center gap-1.5 sm:gap-2 mb-2 sm:mb-3 md:mb-4">
          <div className="w-6 sm:w-8 md:w-12 lg:w-16 h-px bg-[#F2E4D3]/60" />
          <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-[#F2E4D3]/80 rounded-full" />
          <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-[#8B6F5A]/80 rounded-full" />
          <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-[#F2E4D3]/80 rounded-full" />
          <div className="w-6 sm:w-8 md:w-12 lg:w-16 h-px bg-[#F2E4D3]/60" />
        </div>
        
        <h2
          className={`${cinzel.className} text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-normal text-[#F2E4D3] mb-1.5 sm:mb-2 md:mb-3 lg:mb-4 drop-shadow-lg`}
          style={{ textShadow: "0 4px 18px rgba(242,228,211,0.3)" }}
        >
          A Glimpse of Our Love
        </h2>
        
          <p className="text-[0.7rem] sm:text-xs md:text-sm lg:text-base text-[#F2E4D3] font-light max-w-xl mx-auto px-2">
      ...
      <div className="relative z-10 px-3 sm:px-4 md:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="absolute -inset-2 bg-gradient-to-r from-[#4E3B31]/35 via-[#F2E4D3]/22 to-[#4E3B31]/35 blur-2xl opacity-70 group-hover:opacity-90 transition-all duration-500" />
            ...
            <div className="relative bg-gradient-to-br from-black via-[#1a0010] to-black overflow-hidden rounded-lg sm:rounded-xl md:rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.4),0_16px_64px_rgba(0,0,0,0.35),0_0_0_1px_rgba(139,111,90,0.2)] group-hover:shadow-[0_14px_52px_rgba(0,0,0,0.5),0_26px_100px_rgba(0,0,0,0.4),0_0_0_1px_rgba(139,111,90,0.3)] transition-all duration-500">
              {/* Decorative border with gradient */}
              <div className="absolute inset-0 rounded-lg sm:rounded-xl md:rounded-2xl border border-[#F2E4D3]/20 group-hover:border-[#F2E4D3]/35 transition-colors duration-500 pointer-events-none z-20" />
              ...
              <div className="absolute top-0 left-0 w-12 sm:w-16 md:w-20 h-12 sm:h-16 md:h-20 pointer-events-none z-20">
                <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-[#F2E4D3]/60 via-[#F2E4D3]/40 to-transparent" />
                <div className="absolute top-0 left-0 w-px h-full bg-gradient-to-b from-[#F2E4D3]/60 via-[#F2E4D3]/40 to-transparent" />
              </div>
              ...
              <div className="absolute top-0 right-0 w-12 sm:w-16 md:w-20 h-12 sm:h-16 md:h-20 pointer-events-none z-20">
                <div className="absolute top-0 right-0 w-full h-px bg-gradient-to-l from-[#F2E4D3]/60 via-[#F2E4D3]/40 to-transparent" />
                <div className="absolute top-0 right-0 w-px h-full bg-gradient-to-b from-[#F2E4D3]/60 via-[#F2E4D3]/40 to-transparent" />
              </div>
              ...
              <div className="absolute bottom-0 left-0 w-12 sm:w-16 md:w-20 h-12 sm:h-16 md:h-20 pointer-events-none z-20">
                <div className="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-[#F2E4D3]/60 via-[#F2E4D3]/40 to-transparent" />
                <div className="absolute bottom-0 left-0 w-px h-full bg-gradient-to-t from-[#F2E4D3]/60 via-[#F2E4D3]/40 to-transparent" />
              </div>
              ...
              <div className="absolute bottom-0 right-0 w-12 sm:w-16 md:w-20 h-12 sm:h-16 md:h-20 pointer-events-none z-20">
                <div className="absolute bottom-0 right-0 w-full h-px bg-gradient-to-l from-[#F2E4D3]/60 via-[#F2E4D3]/40 to-transparent" />
                <div className="absolute bottom-0 right-0 w-px h-full bg-gradient-to-t from-[#F2E4D3]/60 via-[#F2E4D3]/40 to-transparent" />
              </div>
              ...
              <div className="relative" style={{ paddingBottom: '56.25%' }}>
                ...
                {!hasClicked && (
                  ...
                  >
                    {/* Custom poster image */}
                    <CloudinaryImage
                      src="/desktop-background/couple (14).jpg"
                      alt="Video thumbnail"
                      fill
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      ...
                      >
                        ...
                        <div className="absolute inset-0 rounded-full bg-[#4E3B31]/45 blur-2xl scale-150 group-hover:bg-[#F2E4D3]/55 group-hover:scale-[1.7] transition-all duration-300" />
                        
                        {/* Play button */}
                        <div className="relative flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full bg-white/95 backdrop-blur-sm shadow-[0_8px_32px_rgba(0,0,0,0.4),0_16px_48px_rgba(0,0,0,0.25),0_0_0_1px_rgba(139,111,90,0.2)] group-hover:bg-white group-hover:shadow-[0_12px_52px_rgba(0,0,0,0.5),0_24px_72px_rgba(139,111,90,0.35),0_0_0_1px_rgba(139,111,90,0.3)] transition-all duration-300">
                          <Play className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-[#4E3B31] fill-[#4E3B31] ml-1 drop-shadow-md" />
                        </div>
                      </motion.div>
                    </div>
                  </motion.div>
          ...
          >
            <p className="text-[0.7rem] sm:text-xs md:text-sm lg:text-base text-[#F2E4D3]/80 font-light italic max-w-lg mx-auto px-4">
